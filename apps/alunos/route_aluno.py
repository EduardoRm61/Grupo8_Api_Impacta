...
import apps.alunos.model_aluno as modAl
from . import model_aluno as moda
...
def procurar_aluno_route(id_aluno):
    try:
        aluno = modAl.procurar_aluno_por_id(id_aluno)   #estava assim aluno = modAl.modprocurar_aluno_por_id(id_aluno)
